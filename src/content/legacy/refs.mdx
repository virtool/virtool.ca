...
<Endpoint method="GET" path="/api/refs" />
...
<Request method="GET" path="/api/refs" />
...
<Endpoint method="GET" path="/api/refs/:id" />

### Example

<Request method="GET" path="/api/refs/foo" />
...
To direct Virtool to **link a remote reference and create a new reference from it**, use the `remote_from` field to specify a source GitHub repository slug. Remote reference is automatically linked to its originating GitHub repository and can check and update the [release](https://help.github.com/categories/releases/) for the source repository.

<div title="Warning" color="yellow">
  For now, only the [official
  reference](https://github.com/virtool/virtool-database) is supported as a
  remote reference. Use the slug `virtool/virtool-database` as value for
  `clone_from`.
</div>

<Endpoint method="POST" path="/api/refs" />
...
<Request method="POST" path="/api/refs">
...
<Response status="201 Created" path="/api/refs/f0emv7kz" >
...
<Response status="201 Created" path="/api/refs/3m4glv8c">
...
<Response status="201 Created" path="/api/refs/pe6vunzl" >
...
<Response status="201 Created" path="/api/refs/95p5qnk2">
...
<Permission name="modify" resource="reference" />

Edit an existing reference.

Currently, only _genome_ is accepted as a value for `data_type`.

<Endpoint method="PATCH" path="/api/refs/:id" />
...
<Request method="PATCH" path="/api/refs/o7ed3yfd">
...
<Endpoint method="GET" path="/download/refs/:id" />
...
<Request method="GET" path="/download/refs/848280hu?scope=unbuilt" />
...
<Permission name="remove" resource="reference" />
...
<Endpoint method="DELETE" path="/api/refs/:id" />

### Example

<Request method="DELETE" path="/api/refs/qymrndgk" />

### Response

<Response status="202 Accepted" path="/api/processes/yn5ncv8t">
...
<Endpoint method="GET" path="/api/refs/:id/history" />
...
<Request method="GET" path="/api/refs/35s1gev9/history?per_page=2" />
...
<Endpoint method="GET" path="/api/refs/:id/indexes" />
...
<Request method="GET" path="/api/refs/9fhr3cey/indexes" />
...
<Permission name="build" resource="reference" />

Create an index by starting a new index build job.

This endpoint takes no input.

<Endpoint method="POST" path="/api/refs/:id/indexes" />

### Example

<Request method="POST" path="/api/refs/9fhr3cey/indexes" />

### Response

<Response status="201 Created" path="/api/indexes/bznqwjsa">
...
<Endpoint method="GET" path="/api/refs/:id/user/:id" />

### Example

<Request method="GET" path="/api/refs/pe6vunzl/users/baz" />
...
<Endpoint method="POST" path="/api/refs/:id/users" />
...
<Request method="POST" path="/api/refs/pe6vunzl/users" >
...
<Response status="201 OK" path="/api/refs/pe6vunzl/users/baz">
...
<Endpoint method="PATCH" path="/api/refs/:id/users/:user_id" />
...
<Request method="PATCH" path="/api/refs/pe6vunzl/users/baz">
...
<Endpoint method="DELETE" path="/api/refs/:id/users/:user_id" />

### Example

<Request method="DELETE" path="/api/refs/pe6vunzl/users/baz" />
...
<Endpoint method="GET" path="/api/refs/:id/groups/:group_id" />

### Example

<Request method="GET" path="/api/refs/pe6vunzl/groups/baz" />
...
<Endpoint method="POST" path="/api/refs/:id/groups" />
...
<Request method="POST" path="/api/refs/pe6vunzl/groups">
...
<Response status="201 OK" path="/api/refs/pe6vunzl/groups/baz">
...
<Endpoint method="PATCH" path="/api/refs/:id/groups/:group_id" />
...
<Request method="PATCH" path="/api/refs/pe6vunzl/groups/baz">
...
<Endpoint method="DELETE" path="/api/refs/:id/groups/:group_id" />

### Example

<Request method="DELETE" path="/api/refs/pe6vunzl/groups/baz" />
...
<Endpoint method="GET" path="/api/refs/:id/release" />

### Example

<Request method="GET" path="/api/refs/4n4ezl0t/release" />
...
<Endpoint method="GET" path="/api/refs/:id/updates" />

### Example

<Request method="GET" path="/api/refs/du5m5f51/updates" />
...
<Endpoint method="POST" path="/api/refs/:id/updates" />
...
<Request method="POST" path="/api/refs/4n4ezl0t/updates" />
