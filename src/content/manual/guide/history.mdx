...
1. Navigate to the detail page for an OTU
   ...
   ![OTU Detail Page](/images/history/abtv_detail_old.png)
...
2. Click on the **History** tab to view the history for the OTU
   ...
   ![OTU History Page](/images/history/abtv_history_before.png)

3. Click the <Icon name="history" color="blue" /> icon to revert a change

   Any succeeding changes will also be removed.

   <video src="/images/history/revert.mp4" alt="Revert a change" autoplay />
...
4. Navigate back to the **OTU** tab
   ...
   ![OTU with Reverted Changes](/images/history/abtv_detail.png)
