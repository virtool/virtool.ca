...
2. Choose the workflow(s) (PathoscopeBowtie or NuVs), subtraction, and reference(s) you want to
   use to analyze your sample(s).
...
4. Populate the sample creation form.
   ...
   <Aside title="Paired and Unpaired FASTQ Data">
      ...
      before you create a sample. You can use the 
      <DummyButton color="grey" icon="retweet" /> button to swap orientations.
