...
Virtool uses API keys for authentication. All API endpoints will return <Status code={401} /> for requests without valid authentication.

First, you will need to create an API key with the permission scope defined by you. See the [account documentation](/account#api_key) to learn how to create API keys.
