...
services:
  ...
  create-subtraction:
    ...
    environment:
      ...
      VT_MEM: 2
      VT_PROC: 2
    image: virtool/create-subtraction:4.0.1
    restart: always
    profiles:
      - all
      - backend
  ...
  pathoscope:
    ...
    environment:
      ...
      VT_MEM: 8
      VT_PROC: 8
    # image: virtool/pathoscope:2.0.12
    image: pathoscope:test-9
    restart: always
    profiles:
      - all
      - backend
